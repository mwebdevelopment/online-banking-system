...
elseif($option=='ATM'){
$sql="insert into atm values(LAST_INSERT_ID(),'$name','$account_no','$atm_status')";
...
$sql="insert into cheque_book values(LAST_INSERT_ID(),'$name','$account_no','$cheque_book_status')";
mysqli_query($connect, $sql) or die(mysqli_error($connect));
